...
VALUES ('Nagdev', 'Manish', 'ADMIN', true, 'admin', 'mn@gmail.com', '8888888888');

INSERT INTO user_detail 
(first_name, last_name, role, enabled, password, email, contact_number) 
VALUES ('sewlani', 'Kunal', 'SUPPLIER', true, '12345', 'ks@gmail.com', '9999999999');

INSERT INTO user_detail 
(first_name, last_name, role, enabled, password, email, contact_number) 
VALUES ('kapoor', 'Jitin', 'SUPPLIER', true, '12345', 'jk@gmail.com', '7777777777');
...
VALUES ('PRDABC123DEFX', 'iPhone 7', 'apple', 'This is one of the best phone available in the market right now!', 70000, 5, true, 3, 2 );

INSERT INTO product (code, name, brand, description, unit_price, quantity, is_active, category_id, supplier_id)
VALUES ('PRDDEF123DEFX', 'Samsung s8', 'samsung', 'A smart phone by samsung!', 60000, 2, true, 3, 3 );

INSERT INTO product (code, name, brand, description, unit_price, quantity, is_active, category_id, supplier_id)
VALUES ('PRDPQR123WGTX', 'Google Pixel XL', 'google', 'This is one of the best android smart phone available in the market right now!', 57000, 5, true, 3, 2 );
